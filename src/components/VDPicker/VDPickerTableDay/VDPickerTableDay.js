  ...
  computed: {
    classes () {
      return {
        ...
        'vd-picker__table-day--first': (this.range && this.firstInRange) || (this.firstInHighlightRange && !this.isDisabled),
        'vd-picker__table-day--last': (this.range && this.lastInRange && Boolean(this.mutableDate.end)) || (this.lastInHighlightRange && !this.isDisabled),
